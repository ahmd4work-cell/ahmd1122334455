...
import { collection, onSnapshot, doc, setDoc, deleteDoc } from "[https://www.gstatic.com/firebasejs/12.17.1/firebase-firestore.js](https://www.gstatic.com/firebasejs/12.17.1/firebase-firestore.js)";
...
function renderRow(v = {}, animate = true) {
    ...
    const waHref = initialWaNum.length >= 9 ? `[https://wa.me/$](https://wa.me/$){initialWaNum}` : '#';
...
function updateWhatsAppLink(input) {
    ...
    if (link) {
        if (waNum.length >= 9) {
            link.href = `[https://wa.me/$](https://wa.me/$){waNum}`;
